...
I design and implement data-driven solutions at the intersection of **optimization**, **machine learning**, and **applied AI**. My work focuses on transforming theoretical models into deployable systems—whether it’s reducing logistics costs by 30% through evolutionary algorithms or hardening financial pipelines against fraud with interpretable classifiers.

I specialize in:
- **Optimization**: Genetic Algorithms, combinatorial problem-solving
- **ML Engineering**: End-to-end pipelines from feature engineering to deployment
